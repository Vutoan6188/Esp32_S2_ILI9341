...
TimeChangeRule BST = {"BST", Last, Sun, Mar, 1, 480};        //British Summer (Daylight saving) Time
TimeChangeRule GMT = {"GMT", Last, Sun, Oct, 2, 420};         //Standard Time
Timezone EN(BST, GMT);
...
//GMT +7 for Vietnam
TimeChangeRule VNT = {"VI", Second, Sun, Mar, 2, 420};
Timezone VI(VNT, VNT);
